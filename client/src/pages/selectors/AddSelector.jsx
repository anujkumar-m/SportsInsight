...
import { UserPlus, ChevronLeft, User, Award, ChevronDown, Check, Search, X } from 'lucide-react';
...
const AddSelector = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await selectorService.create(payload);
  ...
  return (
    <div className="fade-in space-y-6 max-w-4xl mx-auto">
      <PageHeader
        title="Add Selector"
        subtitle="Register a new selection committee member with assigned sport expertise."
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <FormSection title="Professional Details" icon={Award}>
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2 space-y-1.5" ref={dropdownRef}>
              <label className="field-label">
