-- ============================================================
-- COMPLETE ACADEMY SCHEMA & SEED DATA (v4 - FINAL)
-- SportsInsight - Sports Academy Management System
-- ============================================================
-- HOW TO RUN:
--   mysql -u root -p < complete_query.sql
--   OR open in MySQL Workbench and execute.
--
-- INCLUDES:
--   Tables : Roles, Users, Sports, Metrics, Categories,
--            Coaches, Athletes, Performance, Fitness,
--            Attendance, Injuries, Rankings, Selections,
--            Notifications, AI Lists, Coach Remarks, etc.
--   Seed Data: 5 athletes, 3 coaches, 2 selectors, 1 admin
--              6-month trend data (2026-03 to 2026-08)
--
-- DEFAULT PASSWORD for ALL users: Admin@123
-- DEFAULT LOGINS:
--   Admin    : admin@sportsacademy.com / Admin@123
--   Coach    : rajesh.kumar@sportsacademy.com / Admin@123
--   Selector : vikram.singh@sportsacademy.com / Admin@123
...
-- â”€â”€ Performance Records (monthly, 2026-03 to 2026-08) â”€â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO performance_records (athlete_id, coach_id, sport_id, record_date, metric_name, metric_value, metric_unit, performance_score, improvement_rate) VALUES
-- Athlete 1 â€” Athletics sprint
...
-- â”€â”€ Fitness Assessments (monthly, 2026-03 to 2026-08) â”€â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO fitness_assessments (athlete_id, coach_id, assessment_date, strength_score, endurance_score, stamina_score, flexibility_score, agility_score, speed_score, reaction_time_ms, balance_score, body_fat_percentage, vo2_max, resting_heart_rate, recovery_rate_bpm, bmi, overall_fitness_score) VALUES
-- Athlete 1
...
-- â”€â”€ Attendance Records (daily, 2026-03-01 to 2026-08-09) â”€â”€â”€â”€â”€â”€
-- Generates monthly totals for the attendance trend chart
-- Athlete 1 â€” ~88% present
INSERT IGNORE INTO attendance (athlete_id, coach_id, attendance_date, status) VALUES
...
-- â”€â”€ Additional Coach Remarks for 2026 period â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO coach_remarks (athlete_id, coach_id, remark_date, remark_type, rating, remarks) VALUES
...
-- â”€â”€ Updated Rankings for 2026 â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO rankings (athlete_id, sport_id, category_id, rank_position, performance_score, fitness_score, consistency_score, overall_ranking_score, rank_type, rank_date) VALUES
